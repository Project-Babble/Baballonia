Invoke-WebRequest -Uri "https://github.com/Project-Babble/BabbleTrainer/releases/latest/download/BabbleTrainer.exe" -OutFile "src/Baballonia.Desktop/Calibration/Windows/Trainer/BabbleTrainer.exe"
...
Invoke-WebRequest -Uri "https://github.com/esp-rs/espflash/releases/latest/download/espflash-x86_64-pc-windows-msvc.zip" -OutFile "src/Baballonia/Firmware/Windows/espflash-x86_64-pc-windows-msvc.zip"
